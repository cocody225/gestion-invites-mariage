Plan d'Action Final : Déployer votre Application de A à Z
Ce guide remplace toutes les instructions précédentes. Suivez ces 4 étapes dans l'ordre pour mettre votre site en ligne.

Étape 1 : Créer un "Dossier de Projet" sur GitHub
GitHub va héberger votre code.

Allez sur GitHub.com et connectez-vous.

Cliquez sur "Create repository" (Créer un dépôt).

Donnez-lui un nom : gestion-invites-mariage.

Cochez la case "Add a README file".

Cliquez sur le bouton vert "Create repository".

Votre dossier de projet est maintenant prêt.

Étape 2 : Ajouter les 8 Fichiers de l'Application sur GitHub
Nous allons maintenant ajouter tous les fichiers nécessaires au projet, un par un.

Pour chaque fichier listé ci-dessous, suivez ces 4 actions :
a. Dans votre dépôt GitHub, cliquez sur "Add file" > "Create new file".
b. Dans la case du nom, tapez le nom exact du fichier.
c. Dans la zone de texte, collez le contenu exact fourni.
d. Cliquez sur le bouton vert "Commit changes".

Fichier 1/8 : package.json
...
Fichier 2/8 : vite.config.js (Version corrigée)

Nom du fichier : vite.config.js
...
Fichier 3/8 : tailwind.config.js
...
Fichier 4/8 : postcss.config.js

Nom du fichier : postcss.config.js
...
Fichier 6/8 : src/main.jsx

Nom du fichier : src/main.jsx (GitHub créera le dossier src automatiquement)
...
Fichier 7/8 : src/index.css

Nom du fichier : src/index.css
...
Fichier 8/8 : src/App.jsx

Nom du fichier : src/App.jsx

Contenu à coller : (C'est le code complet de l'application, déjà configuré pour Netlify)
